---
title: kubeadm으로 단일 마스터를 가진 클러스터 생성하기
...
### (선택 사항) API Server를 로컬호스트에서 프록시하기
...
## 여러 버전을 동시에 사용하기 위한 정책 {#version-skew-policy}
...
## kubeadm은 다양한 플랫폼에서 동작한다 {#multi-platform}
